...
export default function InventarioSucursal({ user, companyContext }) {
  ...
  return <div className="erp-operation-module inventory-module min-w-0 space-y-4 pb-24 lg:pb-6">
    ...
    {tab === "count" ? <>
      <section className="erp-form-panel rounded-lg border border-slate-200 bg-white p-4 sm:p-5">
      ...
      <section className="erp-products-panel overflow-hidden rounded-lg border border-slate-200 bg-white">
    ...
    </> : <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm"><div className="flex items-center justify-between border-b border-slate-200 px-5 py-4"><div><h3 className="text-lg font-black text-slate-950">Levantamientos aplicados</h3><p className="text-xs font-bold text-slate-400">Historial del SICAR local</p></div><button type="button" className="app-icon-button" onClick={() => loadData()}><Icon name="refresh" /></button></div>
