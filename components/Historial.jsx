  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? "linear-gradient(135deg, #e30613 0%, #9f111a 100%)" : "rgba(255,255,255,0.95)",
        color: active ? "#ffffff" : "#475569",
        fontWeight: 800,
        fontSize: "13px",
        cursor: "pointer",
        boxShadow: active ? "0 18px 28px -22px rgba(159, 17, 26, 0.85)" : "none",
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "10px",
                    border: "none",
                    background: modoFecha === option.key ? "linear-gradient(135deg, #e30613 0%, #9f111a 100%)" : "transparent",
