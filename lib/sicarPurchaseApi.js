...
export function receiveSicarPurchase(payload) {
  return request("/compras/recibir", {
    method: "POST",
    body: JSON.stringify(payload),
  });
}
