...
export function buildSicarApiCandidates({
  ...
  const publicGranadaEndpoint = !nativePlatform && normalizedCompany === "granada" ? defaults[0] : "";
  const remainingDefaults = publicGranadaEndpoint ? defaults.slice(1) : defaults;

  return uniqueEndpoints([
    publicGranadaEndpoint,
    lastWorkingEndpoint,
    savedEndpoint,
    localEndpoint,
    ...remainingDefaults,
